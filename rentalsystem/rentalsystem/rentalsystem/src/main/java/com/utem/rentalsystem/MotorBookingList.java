 ...
 * @author 
 */
public class MotorBookingList extends javax.swing.JFrame 
{
    private ArrayList<MotorBooking> motorList;
    private MotorBookingManager  manager = new MotorBookingManager();
    /**
     * Creates new form displayBooking
     */
    public MotorBookingList() 
    {
        initComponents();
        displayBooking();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MotorBookingList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
