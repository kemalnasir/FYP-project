...
public class CarStatus extends javax.swing.JFrame 
{
    ...
    private void displayCarBk() 
    {
       //call method readAll() to fetch all data from database
        carList = manage.readBooked();
        ...
        // tableContent is a table to store the cars properties 
        // carTable is a JTable variable name 
        DefaultTableModel tableContent = (DefaultTableModel) carBookedTbl.getModel(); 
    ...
    private void initComponents() {
        ...
        carBookedTbl = new javax.swing.JTable();
        jLabel1 = new javax.swing.JLabel();
        jLabel3 = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Car Status Page");
        setResizable(false);
        ...
        jScrollPane1.setViewportView(carAvTbl);

        carBookedTbl.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane2.setViewportView(carBookedTbl);

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("CAR ON RENT");

        jLabel3.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("CAR AVAILABLE");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CarStatus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable carBookedTbl;
